...
const BioAndResume = () => {
    ...
    <div className="home-page">
      <div className="container mt-5">
        <div className="row justify-content-center">
          ...
          {/* Profile Card */}
          <div className="col-md-4 mb-4 px-3 me-4 text-center">
  <h4 className="fw-bold mb-5 text-white">PROFILE</h4>
  <motion.div 
  ...
  >
    ...
    >
      ...
      {/* Front Side - "Turn Me Around" */}
      <motion.div className="flip-card-front card">
        <div className="card-body d-flex align-items-center justify-content-center">
          <p className="fs-4 text-white">Turn me around! 🤪</p>
        </div>
      </motion.div>
      ...
      <motion.div className="flip-card-back card text-black">
        <div className="card-body text-center">
          ...
          {/* Skills Card */}
          <div className="col-md-4 mr-4 px-3 text-center">
            <h4 className="fw-bold mb-5 text-white">SKILLS</h4>
            <motion.div 
            ...
            >
              ...
              >
                ...
                <motion.div className="flip-card-front">
                    <p className="fs-4 mt-5">Turn me around! 🤪</p>
                </motion.div>
